...
comp cas@(x:xs) a1 a2 = if computene (x:a1) (delete x a2) == m
                        then x
                        else comp xs a1 a2
...
computefirstme (x:xs) b2 = if computeme x b2 == 1
                           then x
...
computeme e b2 | e `elem` b2 = 1
               | otherwise = 0

computene :: [Move] -> [Move] -> Int
computene a1 [] = 0
computene a1 (x:xs) = if triangle x a1
                      then 1 + computene a1 xs
                      else computene a1 xs

triangle :: Move -> [Move] -> Bool
triangle curmove [] = False
triangle curmove (x:xs) | formtri curmove x = formtri2 curmove x xs ||
                                              triangle curmove xs
                        | otherwise = triangle curmove xs

formtri2 :: Move -> Move -> [Move] -> Bool
formtri2 curmove _ [] = False
formtri2 curmove@(Line a b) (Line p q) (Line r s : xs) = ((b==p) && (a==s) && (q==r)) ||
                                                         ((b==p) && (a==r) && (q==s)) ||
                                                         ((b==q) && (a==s) && (p==r)) ||
                                                         ((b==q) && (a==r) && (p==s)) ||
                                                         ((b==r) && (a==p) && (q==s)) ||
...
moveaux _ _ [] = []
moveaux l1@(Line a b) l2@(Line p q) (l3@(Line r s):xs) = if ((b==p) && (a==s) && (q==r)) ||
                                                            ((b==p) && (a==r) && (q==s)) ||
                                                            ((b==q) && (a==s) && (p==r)) ||
                                                            ((b==q) && (a==r) && (p==s)) ||
                                                            ((b==r) && (a==p) && (q==s)) ||
